...
if __name__ == "__main__":
    ...
    try:
        ...
        # master2 = modbus_tcp.TcpMaster('127.0.0.1', port)
    ...
    while i<2:
        try:
            ...
            master.execute(1,cst.WRITE_SINGLE_COIL, 12, output_value = random_number)

            result = master.execute(1,cst.READ_COILS, 12, 1)
            ...
            time.sleep(1.5)
            result1 = master.execute(1,cst.READ_COILS, 14, 1)
